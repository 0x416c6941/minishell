...
/*   Updated: 2024/12/12 17:42:16 by root             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * environment variables, the function returns EXIT_FAILURE. Otherwise, it
 * returns EXIT_SUCCESS.
 *
 * @param vars A pointer to the t_vars structure containing the environment
 *             variables to be printed.
 * @return int EXIT_SUCCESS on success, EXIT_FAILURE if `vars` is invalid.
 */
